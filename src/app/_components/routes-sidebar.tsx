      ...
      <Dialog.Root open={open} onOpenChange={setOpen}>
        ...
        <Dialog.Portal>
          <Dialog.Content className="pointer-events-auto fixed inset-y-4 left-4 z-50 flex min-w-[340px] max-w-[600px] flex-col overflow-hidden rounded-lg border bg-background p-3 shadow-xl">
            ...
            {/* Mode Toggle */}
            <div className="mb-3 grid grid-cols-3 gap-2 rounded-lg bg-muted/40 p-1">
              <button
                type="button"
                onClick={() => onModeChange("explore")}
                className={`flex items-center justify-center gap-1.5 rounded-md px-2 py-2.5 text-xs font-medium transition ${
...
// Helper components for saved items
              ...
              >
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors text-xs font-medium"
                  >
                  ...
                  {deleteConfirm === item.id ? (
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-2 py-1.5 bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors text-xs font-medium"
                      >
                        Confirm
                      </button>
                      <button
                        onClick={() => onDeleteConfirm(null)}
                        className="px-2 py-1.5 bg-muted text-foreground rounded-md hover:bg-muted/80 transition-colors text-xs font-medium"
                      >
                        Cancel
                      </button>
                    </div>
                    ...
                    <button
                      ...
                      className="px-2 py-1.5 bg-red-50 text-red-600 rounded-md hover:bg-red-100 transition-colors"
                    >
